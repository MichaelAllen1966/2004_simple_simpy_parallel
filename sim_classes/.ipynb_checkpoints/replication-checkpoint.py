...
class Replicator:
    ...
    def pivot_results(self):  
        ...
        # Ensure all data is is a form for aggregation (later versions of Pandas
        # only)
        try:
        ...
        # Rename NumPy 'amin' and 'amax' output to 'min' and 'max'
        pivot.rename(columns={'amin': 'min', 'amax': 'max'}, inplace=True)
        self.patients_pivot = pivot
    ...
    def print_results(self):
        ...
        print('----------------')
        print(self.patients_pivot[['median', 'max']])
        print('\n\n')
        print('Queuing times')
        print('-------------')
